...
public class TC_RF_018 {
	...
	public void verifyRegisteringAccountFieldsHeightWidthAligment() throws IOException {
		...
		Assert.assertFalse(compareTwoScreenshots(System.getProperty("user.dir")+"\\Screenshots\\registerPageActualAligment.png", System.getProperty("user.dir")+"\\Screenshots\\registerPageExpectedAligment.png"));
